...
class ClientRequest(models.Model):
    ...
    brief_document = models.FileField(upload_to='client_briefs/', blank=True, null=True, help_text='Upload a brief or proposal (PDF, DOCX)')
    consent_given = models.BooleanField(default=False, help_text='POPIA consent for data processing')
